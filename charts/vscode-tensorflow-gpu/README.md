...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-tensorflow:py3.10.9-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-tensorflow:py3.10.9-gpu"` |  |
